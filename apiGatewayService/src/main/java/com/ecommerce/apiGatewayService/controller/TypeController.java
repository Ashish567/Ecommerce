...
import com.ecommerce.apiGatewayService.model.Type;
import com.ecommerce.apiGatewayService.utils.AuthUtil;
...
public class TypeController {
    ...
    public TypeController(RestTemplate restTemplate, AuthUtil authUtil) {
...
//            }
    ...
    private HttpHeaders setAuthHeader(String email, String password) {
        HttpHeaders headers = new HttpHeaders();
        headers.set("Authorization", "Bearer " + authUtil.getToken(email, password));
        return headers;
    }
